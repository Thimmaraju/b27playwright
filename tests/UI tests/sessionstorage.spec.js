...
test.describe('Validate Orange HRM Login functionality with SessionStorage', () => {
  ...
  test("Add Employee",  async ({ page }) => {
    ...
    page.goto("/web/index.php/pim/addEmployee")

    // fill firstname 
    await page.locator("(//label[normalize-space(text())='Employee Full Name']/following::input)[1]").fill("Latha")
    
    // fill lastname 
    
  
    await page.locator("//input[@placeholder='Last Name']").fill("brehfb")
